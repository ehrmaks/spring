...
public class UploadFileUtils {
	...
	public static String uploadFile(String uploadPath, 
		...
		System.out.println("UploadUtils's name : " + formatName);
		...
		if(MediaUtils.getMediaType(formatName) != null) {
			...
			System.out.println("썸네일사용 : " + uploadedFileName);
		} else {
			uploadedFileName = makeIcon(uploadPath, savedPath, savedName);
			System.out.println("아이콘사용 : " + uploadedFileName);
		}
	...
	private static void makeDir(String uploadPath, 
			String... paths) { // ...은 여러가지 변수가 들어올수있다.
		// 디렉토리가 존재하면 skip
