				...
				<div class="dropdown-menu dropdown-menu-right"
					...
					<a class="dropdown-item" href="/admin/login.do">관리자 로그인</a>
						...
						<c:otherwise>
							...
							<a class="dropdown-item" href="#">${sessionScope.admin_name}님</a>
	...
	<div id="wrapper">
		...
		<ul class="sidebar navbar-nav">
			...
			<li class="nav-item dropdown"><a
				class="nav-link dropdown-toggle" href="#" id="pagesDropdown"
				role="button" data-toggle="dropdown" aria-haspopup="true"
				aria-expanded="false"> <i class="fas fa-fw fa-table"></i> <span>My
						Page</span>
			</a>
				...
				<div class="dropdown-menu" aria-labelledby="pagesDropdown">
					...
					<a class="dropdown-item" href="/admin/login.do">관리자 로그인</a>
						...
						<c:otherwise>
							...
							<a class="dropdown-item" href="javascript:refreshTimer();">Session
								Time 연장</a>
