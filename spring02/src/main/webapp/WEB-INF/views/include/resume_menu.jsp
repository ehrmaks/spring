    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="/board/list.do">게시판</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="/upload/uploadForm">업로드 테스트</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="/upload/uploadAjax">업로드(Ajax)</a>
          </li>
          <li class="nav-item">
          	
            <a class="nav-link js-scroll-trigger" href="/shop/product/list.do">상품목록</a>
            
          </li>
          
          <li class="nav-item">
          	
            <a class="nav-link js-scroll-trigger" href="/chatting.do">웹소켓 테스트</a>
            
          </li>
          
          <c:if test="${sessionScope.admin_userid != null}">
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="/messages/write.do">메시지 전송</a>
          </li>
          </c:if>
          
          <c:if test="${sessionScope.admin_userid != null}">
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="/shop/product/write.do">상품등록</a>      
          </li>
          </c:if>
          
          <c:if test="${sessionScope.userid != null}">
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="/shop/cart/list.do">장바구니</a>
          </li>
          </c:if>
